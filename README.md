...
garde-fous, tous deux ajustables depuis l'interface :

**1. Exclusion ferme par famille de métier** (panneau 🚫 FILTRES D'EXCLUSION). 15 familles
cochables : vente/caisse, restauration/métiers de bouche, mécanique/garage, BTP, santé/social,
compta/finance/juridique/assurance/immobilier, RH, commercial/achats, marketing/communication,
logistique/transport, informatique pure, accueil/secrétariat, propreté/sécurité, coiffure/
esthétique, agriculture. Détecté dans le **titre** → l'offre est écartée quel que soit son score.
Détecté seulement dans la **description** → simple malus, car une offre technique peut mentionner
"vente" ou "marketing" de façon annexe. Chaque famille est décochable, et un champ libre permet
d'ajouter ses propres mots éliminatoires.

**2. Exigence de signal positif.** Une offre sans aucun mot-clé technique pertinent (score de
domaine ≥ 10 dans au moins un des 6 domaines, ou un mot-clé perso) est plafonnée à 20 et sortie
des vues principales, même si aucune famille d'exclusion ne la vise. Sans ce garde-fou, une offre
générique passe entre les mailles simplement parce qu'aucun mot ne la disqualifie explicitement.

Les offres écartées ne disparaissent pas : l'onglet **🚫 Écartées** les liste avec la raison
exacte, pour vérifier qu'aucun filtre n'est trop agressif et le décocher le cas échéant.
